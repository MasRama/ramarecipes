...
<div class="flex flex-col rounded shadow-sm bg-white overflow-hidden">
          <div class="p-5 lg:p-6 grow w-full">
            <div class="sm:p-5 lg:px-10 lg:py-8">
              ...
              <form action="/login" method="POST" enctype="multipart/form-data" class="space-y-6">
                <div class="space-y-1">
          ...
          <div class="py-4 px-5 lg:px-6 w-full text-sm text-center bg-gray-50">
            Belum punya akun?
            <a class="font-medium text-indigo-600 hover:text-indigo-400" href="/register">Daftar disini</a>
          </div>
        </div>
<?= $this->endSection() ?>